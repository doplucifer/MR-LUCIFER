// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮LUCIFER-MD  2022 ®️ALL RIGHTS RESERVED
//▮
...
//┃
//┃THANKS FOR CHOOSING LUCIFER-MD
...
global.footer = 'LUCIFER-MD BOT'
global.botnma = 'LUCIFER-MD' //bot name
global.botname = 'LUCIFER-MD'
global.ownernma = 'LUCIFER' //owner name
global.packname = 'LUCIFER STICKRT' //sticker package name
...
global.mess = {
    success: 'Done✔',
    admin: '*This feature is only for admin!😂➳̶̶̶᭄➤*',
    botAdmin: '*Lucifer-md bot  must be admin first!😅*'
    owner: '*this feature is only for lucifer-md owner😒*',
